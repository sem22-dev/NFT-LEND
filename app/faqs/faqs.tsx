...
export default function Faqs(){
    return (
        <div className="space-y-4 flex flex-col border-b justify-center px-7 md:px-16 lg:mx-32 py-16">
        ...
        <div className="lg:px-48 flex flex-col gap-2">
            <details
            className="group border-l-4 border-header bg-gray-50 p-6 [&_summary::-webkit-details-marker]:hidden"
        >
