...
export default function Home(){
    return(
        ...
        <div>
            <div className="pt-10 px-7 hidden md:block lg:px-16 bg-center bg-cover bg-no-repeat sm:max-w-full h-[500px] lg:h-[700px] " style={{ backgroundImage: "url('/images/backgroundImage3.png')" }}>
